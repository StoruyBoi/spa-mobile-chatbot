            ...
            return (
              <>
                <label className="control">
                      ...
                      />
                      <span className="control__content"><p>{itemTime.date}</p> <p id="target"> {itemTime.day}</p></span>
                      </label>
                  ...
                  <label className="control">
                    <input  type="checkbox"  id="technology" 
                     ...
                     onChange={handleCheckboxChange}
                      ...
                      name="check"
                    />
                    <span className="control__content"><p>{itmeTIme.mor}</p></span>
                    </label>
                  ...
                  <label className="control">
                    <input type="checkbox"  id="technology"
                     ...
                     onChange={handleCheckboxChange}
                      name="check"
                    />
                    <span className="control__content"><p>{itmeTIme.noon}</p></span>
                    </label>
